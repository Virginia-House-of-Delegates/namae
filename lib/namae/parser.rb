...
module_eval(<<'...end parser.y/module_eval...', 'parser.y', 106)
  ...
  @defaults = {
    ...
    :title => /\s*\b(sir|lord|count(ess)?|(doctor|clerk|gen|adm|col|maj|capt|cmdr|lt|sgt|cpl|pvt|pastor|pr|reverend|rev|elder|deacon|deaconess|father|fr|rabbi|cantor|vicar|prof|dr|md|ph\.?d)\.?)(\s+|$)/i,
